...
class GaussianExtractor(object):
    def __init__(self, gaussians, exposure_model, gaussian_render):
        """
    ...
    def reconstruction(self, viewpoint_stack):
        ...
        for i, viewpoint_cam in tqdm(enumerate(self.viewpoint_stack), desc="reconstruct radiance fields"):
            ...
            src_render_image, render_depth, render_mask = render_pkg["render"], render_pkg["depth"], render_pkg["mask"]
            #visibility_filter = render_pkg["visibility_filter"]
            if self.exposure_model is not None:
                render_image = self.exposure_model(viewpoint_cam.cam_idx, src_render_image)
            else:
                render_image = src_render_image
            self.rgbmaps.append(render_image.cpu())
            self.depthmaps.append(render_depth.cpu())
